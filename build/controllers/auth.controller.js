...
const register = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const token = yield (0, jwt_1.createAccessToken)({ id: userSaved._id }); // crea el token con el id del usuario
...
const login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const userFound = yield user_model_1.default.findOne({ email }); //Buscamos el usuario por email en la base de datos
        ...
        const token = yield (0, jwt_1.createAccessToken)({ id: userFound._id }); //Creamos el token para mandarlo al front
        res.cookie("token", token); // guarda el token en una cookie, y lo enviamos en el header seteado como cookie.
        return res.json({
            id: userFound._id,
...
const crud = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const userFound = yield user_model_1.default.findById(req.id); //req.user.id viene del middleware validateToken el cual tiene el id, que previamente fue decodificado
    if (!userFound) {
        return res.status(400).json({ message: "Usuario no encontrado" });
    }
    return res.json({
...
const verifyToken = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    jsonwebtoken_1.default.verify(token, config_1.TOKEN_SECRET, (error, user) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const userFound = yield user_model_1.default.findById(user.id); // Busca el usuario en la base de datos por el id que viene en el token decodificado 
